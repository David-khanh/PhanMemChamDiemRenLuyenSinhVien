...
{
    public partial class DanhGiaDRL_ADMIN : Form
    {
        public DanhGiaDRL_ADMIN()
        {
            InitializeComponent();
        ...
        private void DanhGiaDRL_ADMIN_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var quyry = from a in data.ChamDiemRLs
                                ...
                                join tc in data.TieuChis on pc.maTieuChi equals tc.maTieuChi
                                join nd in data.NoiDungs on pc.maNoiDung equals nd.maNoiDung
                                where a.maPhieuCham == Convert.ToInt32(txt_maphieu.Text.ToString()) && pc.diemL3 != 0
